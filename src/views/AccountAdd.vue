  ...
  <div class="w-full">
    ...
    <div class="grid grid-cols-12 gap-4">
      ...
      <div class="col-span-3">
        <input class="checkbox cursor-pointer" type="checkbox" :value="ROLE.ADMIN" id="roleAdminCheckbox" v-model="formData.roles"/>
        <label
      ...
      <div class="col-span-6">
        <input class="checkbox cursor-pointer" type="checkbox" :value="ROLE.EDITOR" id="roleEditorCheckbox" v-model="formData.roles"/>
        <label
            class="inline-block pl-[0.15rem] cursor-pointer"
